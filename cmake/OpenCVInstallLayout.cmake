...
if(ANDROID)
  ...
  ocv_update(OPENCV_BIN_INSTALL_PATH            "sdk/native/bin/${__ndk_abi_name}")
  ocv_update(OPENCV_TEST_INSTALL_PATH           "${OPENCV_BIN_INSTALL_PATH}")
  ocv_update(OPENCV_SAMPLES_BIN_INSTALL_PATH    "sdk/native/samples/${__ndk_abi_name}")
  ocv_update(OPENCV_LIB_INSTALL_PATH            "sdk/native/libs/${__ndk_abi_name}")
  ocv_update(OPENCV_LIB_ARCHIVE_INSTALL_PATH    "sdk/native/staticlibs/${__ndk_abi_name}")
  ocv_update(OPENCV_3P_LIB_INSTALL_PATH         "sdk/native/3rdparty/libs/${__ndk_abi_name}")
