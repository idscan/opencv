...
class TimestampDefaultTypeInternal {
 public:
  ::cv::protobuf::internal::ExplicitlyConstructed<Timestamp>
      _instance;
...
void InitDefaultsTimestampImpl() {
  ...
  {
    void* ptr = &::cv::protobuf::_Timestamp_default_instance_;
    new (ptr) ::cv::protobuf::Timestamp();
    ::cv::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::cv::protobuf::Timestamp::InitAsDefaultInstance();
}

void InitDefaultsTimestamp() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::cv::protobuf::GoogleOnceInit(&once, &InitDefaultsTimestampImpl);
}
...
const ::cv::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cv::protobuf::Timestamp, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cv::protobuf::Timestamp, seconds_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cv::protobuf::Timestamp, nanos_),
};
static const ::cv::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::cv::protobuf::Timestamp)},
};

static ::cv::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::cv::protobuf::Message*>(&::cv::protobuf::_Timestamp_default_instance_),
};
...
void Timestamp::RegisterArenaDtor(::cv::protobuf::Arena* arena) {
}
...
Timestamp* Timestamp::New(::cv::protobuf::Arena* arena) const {
  return ::cv::protobuf::Arena::CreateMessage<Timestamp>(arena);
}
...
::cv::protobuf::uint8* Timestamp::InternalSerializeWithCachedSizesToArray(
...
void Timestamp::MergeFrom(const ::cv::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:google.protobuf.Timestamp)
  GOOGLE_DCHECK_NE(&from, this);
  const Timestamp* source =
      ::cv::protobuf::internal::DynamicCastToGenerated<const Timestamp>(
          &from);
  if (source == NULL) {
...
void Timestamp::CopyFrom(const ::cv::protobuf::Message& from) {
