...
class LIBPROTOBUF_EXPORT SourceContext : public ::cv::protobuf::Message /* @@protoc_insertion_point(class_definition:google.protobuf.SourceContext) */ {
 public:
  SourceContext();
  ...
  SourceContext* New(::cv::protobuf::Arena* arena) const PROTOBUF_FINAL;
