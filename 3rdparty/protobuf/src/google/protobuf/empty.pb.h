...
class LIBPROTOBUF_EXPORT Empty : public ::cv::protobuf::Message /* @@protoc_insertion_point(class_definition:google.protobuf.Empty) */ {
 public:
  Empty();
  virtual ~Empty();
  ...
  Empty* New(::cv::protobuf::Arena* arena) const PROTOBUF_FINAL;
  ...
  protected:
  explicit Empty(::cv::protobuf::Arena* arena);
  private:
 ...
 private:
  ...
  friend struct ::protobuf_cv_2fprotobuf_2fempty_2eproto::TableStruct;
  friend void ::protobuf_cv_2fprotobuf_2fempty_2eproto::InitDefaultsEmptyImpl();
};
// ===================================================================
