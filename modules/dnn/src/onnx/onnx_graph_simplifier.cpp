...
Mat getMatFromTensor(opencv_onnx::TensorProto& tensor_proto)
{
    ...
    if (datatype == opencv_onnx::TensorProto_DataType_FLOAT) {
        ...
        if (!tensor_proto.float_data().empty()) {
            const ::cv::protobuf::RepeatedField<float> field = tensor_proto.float_data();
    ...
    {
        const ::cv::protobuf::RepeatedField<double> field = tensor_proto.double_data();
    ...
    else if (datatype == opencv_onnx::TensorProto_DataType_INT64)
    {
        ...
        if (!tensor_proto.int64_data().empty()) {
            ::cv::protobuf::RepeatedField< ::cv::protobuf::int64> src = tensor_proto.int64_data();
