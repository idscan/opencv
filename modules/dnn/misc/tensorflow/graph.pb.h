...
struct TableStruct {
  ...
  static const ::PROTOBUF_NAMESPACE::internal::ParseTable schema[3];
...
class GraphDef : public ::PROTOBUF_NAMESPACE::Message /* @@protoc_insertion_point(class_definition:opencv_tensorflow.GraphDef) */ {
 public:
  GraphDef();
  virtual ~GraphDef();
  ...
  GraphDef* New(::PROTOBUF_NAMESPACE::Arena* arena) const PROTOBUF_FINAL;
  ...
  protected:
  explicit GraphDef(::PROTOBUF_NAMESPACE::Arena* arena);
  private:
  ...
  ::PROTOBUF_NAMESPACE::RepeatedPtrField< ::opencv_tensorflow::NodeDef >*
      mutable_node();
  const ::PROTOBUF_NAMESPACE::RepeatedPtrField< ::opencv_tensorflow::NodeDef >&
      node() const;
  ...
  GOOGLE_PROTOBUF_DEPRECATED_ATTR ::PROTOBUF_NAMESPACE::int32 version() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_version(::PROTOBUF_NAMESPACE::int32 value);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE::RepeatedPtrField< ::opencv_tensorflow::NodeDef > node_;
...
class NodeDef_AttrEntry_DoNotUse : public ::PROTOBUF_NAMESPACE::internal::MapEntry<NodeDef_AttrEntry_DoNotUse,
    ...
    0 > {
public:
  typedef ::PROTOBUF_NAMESPACE::internal::MapEntry<NodeDef_AttrEntry_DoNotUse,
    ::std::string, ::opencv_tensorflow::AttrValue,
    ::PROTOBUF_NAMESPACE::internal::WireFormatLite::TYPE_STRING,
    ::PROTOBUF_NAMESPACE::internal::WireFormatLite::TYPE_MESSAGE,
    0 > SuperType;
  NodeDef_AttrEntry_DoNotUse();
  NodeDef_AttrEntry_DoNotUse(::PROTOBUF_NAMESPACE::Arena* arena);
...
class NodeDef : public ::PROTOBUF_NAMESPACE::Message /* @@protoc_insertion_point(class_definition:opencv_tensorflow.NodeDef) */ {
 public:
  NodeDef();
  virtual ~NodeDef();
  ...
  NodeDef* New(::PROTOBUF_NAMESPACE::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::PROTOBUF_NAMESPACE::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::PROTOBUF_NAMESPACE::Message& from) PROTOBUF_FINAL;
  ...
  protected:
  explicit NodeDef(::PROTOBUF_NAMESPACE::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE::Arena* arena);
  private:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE::internal::ArenaStringPtr device_;
  mutable int _cached_size_;
  friend struct ::protobuf_graph_2eproto::TableStruct;
...
inline ::PROTOBUF_NAMESPACE::RepeatedPtrField< ::opencv_tensorflow::NodeDef >*
GraphDef::mutable_node() {
  // @@protoc_insertion_point(field_mutable_list:opencv_tensorflow.GraphDef.node)
  return &node_;
}
inline const ::PROTOBUF_NAMESPACE::RepeatedPtrField< ::opencv_tensorflow::NodeDef >&
GraphDef::node() const {
...
inline void GraphDef::set_allocated_versions(::opencv_tensorflow::VersionDef* versions) {
  ...
  if (message_arena == NULL) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE::MessageLite*>(versions_);
  }
  if (versions) {
    ::PROTOBUF_NAMESPACE::Arena* submessage_arena =
      reinterpret_cast< ::PROTOBUF_NAMESPACE::MessageLite*>(versions)->GetArena();
    if (message_arena != submessage_arena) {
      versions = ::PROTOBUF_NAMESPACE::internal::GetOwnedMessage(
...
inline ::PROTOBUF_NAMESPACE::int32 GraphDef::version() const {
  // @@protoc_insertion_point(field_get:opencv_tensorflow.GraphDef.version)
  return version_;
}
inline void GraphDef::set_version(::PROTOBUF_NAMESPACE::int32 value) {
...
inline void GraphDef::set_allocated_library(::opencv_tensorflow::FunctionDefLibrary* library) {
  ::PROTOBUF_NAMESPACE::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE::MessageLite*>(library_);
  }
  if (library) {
    ::PROTOBUF_NAMESPACE::Arena* submessage_arena =
      reinterpret_cast< ::PROTOBUF_NAMESPACE::MessageLite*>(library)->GetArena();
    if (message_arena != submessage_arena) {
      library = ::PROTOBUF_NAMESPACE::internal::GetOwnedMessage(
...
inline void NodeDef::set_device(const ::std::string& value) {
  ...
  device_.Set(&::PROTOBUF_NAMESPACE::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
...
inline void NodeDef::set_device(const char* value) {
  ...
  device_.Set(&::PROTOBUF_NAMESPACE::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
...
inline void NodeDef::set_device(const char* value,
  ...
  device_.Set(&::PROTOBUF_NAMESPACE::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
...
inline ::std::string* NodeDef::mutable_device() {
  ...
  return device_.Mutable(&::PROTOBUF_NAMESPACE::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* NodeDef::release_device() {
  // @@protoc_insertion_point(field_release:opencv_tensorflow.NodeDef.device)

  return device_.Release(&::PROTOBUF_NAMESPACE::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline void NodeDef::set_allocated_device(::std::string* device) {
  ...
  device_.SetAllocated(&::PROTOBUF_NAMESPACE::internal::GetEmptyStringAlreadyInited(), device,
      GetArenaNoVirtual());
...
inline ::std::string* NodeDef::unsafe_arena_release_device() {
  ...
  return device_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE::internal::GetEmptyStringAlreadyInited(),
      GetArenaNoVirtual());
}
inline void NodeDef::unsafe_arena_set_allocated_device(
  ...
  device_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE::internal::GetEmptyStringAlreadyInited(),
