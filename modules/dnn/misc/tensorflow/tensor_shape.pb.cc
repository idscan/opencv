...
class TensorShapeProto_DimDefaultTypeInternal {
 public:
  ::cv::protobuf::internal::ExplicitlyConstructed<TensorShapeProto_Dim>
      _instance;
...
void InitDefaultsTensorShapeProto_Dim() {
  ...
  ::cv::protobuf::GoogleOnceInit(&once, &InitDefaultsTensorShapeProto_DimImpl);
}
...
::cv::protobuf::Metadata file_level_metadata[2];
...
static ::cv::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::cv::protobuf::Message*>(&::opencv_tensorflow::_TensorShapeProto_Dim_default_instance_),
  reinterpret_cast<const ::cv::protobuf::Message*>(&::opencv_tensorflow::_TensorShapeProto_default_instance_),
};
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::cv::protobuf::internal::RegisterAllTypes(file_level_metadata, 2);
}
...
TensorShapeProto_Dim::TensorShapeProto_Dim(::cv::protobuf::Arena* arena)
  : ::cv::protobuf::Message(),
...
void TensorShapeProto_Dim::RegisterArenaDtor(::cv::protobuf::Arena* arena) {
}
...
const ::cv::protobuf::Descriptor* TensorShapeProto_Dim::descriptor() {
...
TensorShapeProto_Dim* TensorShapeProto_Dim::New(::cv::protobuf::Arena* arena) const {
  return ::cv::protobuf::Arena::CreateMessage<TensorShapeProto_Dim>(arena);
}
...
void TensorShapeProto_Dim::SerializeWithCachedSizes(
  ...
  // int64 size = 1;
  if (this->size() != 0) {
    ::cv::protobuf::internal::WireFormatLite::WriteInt64(1, this->size(), output);
  }
...
::cv::protobuf::uint8* TensorShapeProto_Dim::InternalSerializeWithCachedSizesToArray(
  ...
  // int64 size = 1;
  if (this->size() != 0) {
    target = ::cv::protobuf::internal::WireFormatLite::WriteInt64ToArray(1, this->size(), target);
  }
...
void TensorShapeProto_Dim::MergeFrom(const ::cv::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:opencv_tensorflow.TensorShapeProto.Dim)
  ...
  const TensorShapeProto_Dim* source =
      ::cv::protobuf::internal::DynamicCastToGenerated<const TensorShapeProto_Dim>(
          &from);
  if (source == NULL) {
...
void TensorShapeProto_Dim::CopyFrom(const ::cv::protobuf::Message& from) {
...
::cv::protobuf::Metadata TensorShapeProto_Dim::GetMetadata() const {
  protobuf_tensor_5fshape_2eproto::protobuf_AssignDescriptorsOnce();
...
TensorShapeProto::TensorShapeProto(::cv::protobuf::Arena* arena)
  : ::cv::protobuf::Message(),
  _internal_metadata_(arena),
  dim_(arena) {
  ::protobuf_tensor_5fshape_2eproto::InitDefaultsTensorShapeProto();
...
void TensorShapeProto::RegisterArenaDtor(::cv::protobuf::Arena* arena) {
}
...
TensorShapeProto* TensorShapeProto::New(::cv::protobuf::Arena* arena) const {
  return ::cv::protobuf::Arena::CreateMessage<TensorShapeProto>(arena);
}
...
void TensorShapeProto::SerializeWithCachedSizes(
  ...
  if (this->unknown_rank() != 0) {
    ::cv::protobuf::internal::WireFormatLite::WriteBool(3, this->unknown_rank(), output);
  }
...
::cv::protobuf::uint8* TensorShapeProto::InternalSerializeWithCachedSizesToArray(
  ...
  // bool unknown_rank = 3;
  if (this->unknown_rank() != 0) {
    target = ::cv::protobuf::internal::WireFormatLite::WriteBoolToArray(3, this->unknown_rank(), target);
  }
