...
class VersionDef : public ::PROTOBUF_NAMESPACE::Message /* @@protoc_insertion_point(class_definition:opencv_tensorflow.VersionDef) */ {
 public:
  VersionDef();
  virtual ~VersionDef();
  ...
  VersionDef* New(::PROTOBUF_NAMESPACE::Arena* arena) const PROTOBUF_FINAL;
  ...
  protected:
  explicit VersionDef(::PROTOBUF_NAMESPACE::Arena* arena);
  private:
  ...
  ::PROTOBUF_NAMESPACE::int32 bad_consumers(int index) const;
  void set_bad_consumers(int index, ::PROTOBUF_NAMESPACE::int32 value);
  void add_bad_consumers(::PROTOBUF_NAMESPACE::int32 value);
  ...
  ::PROTOBUF_NAMESPACE::int32 producer() const;
  void set_producer(::PROTOBUF_NAMESPACE::int32 value);

  // int32 min_consumer = 2;
  void clear_min_consumer();
  static const int kMinConsumerFieldNumber = 2;
  ::PROTOBUF_NAMESPACE::int32 min_consumer() const;
  void set_min_consumer(::PROTOBUF_NAMESPACE::int32 value);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE::RepeatedField< ::PROTOBUF_NAMESPACE::int32 > bad_consumers_;
  mutable int _bad_consumers_cached_byte_size_;
  ::PROTOBUF_NAMESPACE::int32 producer_;
  ::PROTOBUF_NAMESPACE::int32 min_consumer_;
...
inline ::PROTOBUF_NAMESPACE::int32 VersionDef::producer() const {
  // @@protoc_insertion_point(field_get:opencv_tensorflow.VersionDef.producer)
  return producer_;
}
inline void VersionDef::set_producer(::PROTOBUF_NAMESPACE::int32 value) {
...
inline ::PROTOBUF_NAMESPACE::int32 VersionDef::min_consumer() const {
  // @@protoc_insertion_point(field_get:opencv_tensorflow.VersionDef.min_consumer)
  return min_consumer_;
}
inline void VersionDef::set_min_consumer(::PROTOBUF_NAMESPACE::int32 value) {
...
inline ::PROTOBUF_NAMESPACE::int32 VersionDef::bad_consumers(int index) const {
  // @@protoc_insertion_point(field_get:opencv_tensorflow.VersionDef.bad_consumers)
  return bad_consumers_.Get(index);
}
inline void VersionDef::set_bad_consumers(int index, ::PROTOBUF_NAMESPACE::int32 value) {
  bad_consumers_.Set(index, value);
  // @@protoc_insertion_point(field_set:opencv_tensorflow.VersionDef.bad_consumers)
}
inline void VersionDef::add_bad_consumers(::PROTOBUF_NAMESPACE::int32 value) {
