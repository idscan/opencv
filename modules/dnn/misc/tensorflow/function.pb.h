...
class FunctionDefLibrary : public ::cv::protobuf::Message /* @@protoc_insertion_point(class_definition:opencv_tensorflow.FunctionDefLibrary) */ {
 public:
  FunctionDefLibrary();
  ...
  FunctionDefLibrary* New(::cv::protobuf::Arena* arena) const PROTOBUF_FINAL;
  ...
  protected:
  explicit FunctionDefLibrary(::cv::protobuf::Arena* arena);
  private:
  ...
  ::cv::protobuf::RepeatedPtrField< ::opencv_tensorflow::FunctionDef >*
      mutable_function();
  const ::cv::protobuf::RepeatedPtrField< ::opencv_tensorflow::FunctionDef >&
      function() const;
  ...
  ::cv::protobuf::RepeatedPtrField< ::opencv_tensorflow::GradientDef >*
      mutable_gradient();
  const ::cv::protobuf::RepeatedPtrField< ::opencv_tensorflow::GradientDef >&
      gradient() const;
 ...
 private:
  ...
  ::cv::protobuf::RepeatedPtrField< ::opencv_tensorflow::FunctionDef > function_;
  ::cv::protobuf::RepeatedPtrField< ::opencv_tensorflow::GradientDef > gradient_;
...
class FunctionDef_Node_AttrEntry_DoNotUse : public ::cv::protobuf::internal::MapEntry<FunctionDef_Node_AttrEntry_DoNotUse,
    ...
    0 > {
public:
  typedef ::cv::protobuf::internal::MapEntry<FunctionDef_Node_AttrEntry_DoNotUse,
    ::std::string, ::opencv_tensorflow::AttrValue,
    ::cv::protobuf::internal::WireFormatLite::TYPE_STRING,
    ::cv::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
    0 > SuperType;
  FunctionDef_Node_AttrEntry_DoNotUse();
  FunctionDef_Node_AttrEntry_DoNotUse(::cv::protobuf::Arena* arena);
...
class FunctionDef_Node : public ::cv::protobuf::Message /* @@protoc_insertion_point(class_definition:opencv_tensorflow.FunctionDef.Node) */ {
 public:
  FunctionDef_Node();
  ...
  FunctionDef_Node* New(::cv::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::cv::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::cv::protobuf::Message& from) PROTOBUF_FINAL;
  ...
  protected:
  explicit FunctionDef_Node(::cv::protobuf::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::cv::protobuf::Arena* arena);
  private:
  ...
  const ::cv::protobuf::RepeatedPtrField< ::std::string>& ret() const;
  ::cv::protobuf::RepeatedPtrField< ::std::string>* mutable_ret();
  ...
  const ::cv::protobuf::RepeatedPtrField< ::std::string>& arg() const;
  ::cv::protobuf::RepeatedPtrField< ::std::string>* mutable_arg();
  ...
  const ::cv::protobuf::RepeatedPtrField< ::std::string>& dep() const;
  ::cv::protobuf::RepeatedPtrField< ::std::string>* mutable_dep();

  // map<string, .opencv_tensorflow.AttrValue> attr = 5;
  int attr_size() const;
  void clear_attr();
  static const int kAttrFieldNumber = 5;
  const ::cv::protobuf::Map< ::std::string, ::opencv_tensorflow::AttrValue >&
      attr() const;
  ::cv::protobuf::Map< ::std::string, ::opencv_tensorflow::AttrValue >*
      mutable_attr();
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::cv::protobuf::RepeatedPtrField< ::std::string> ret_;
  ::cv::protobuf::RepeatedPtrField< ::std::string> arg_;
  ::cv::protobuf::RepeatedPtrField< ::std::string> dep_;
  ::cv::protobuf::internal::MapField<
      ...
      ::cv::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
      0 > attr_;
  ::cv::protobuf::internal::ArenaStringPtr op_;
  mutable int _cached_size_;
  friend struct ::protobuf_function_2eproto::TableStruct;
...
class FunctionDef : public ::cv::protobuf::Message /* @@protoc_insertion_point(class_definition:opencv_tensorflow.FunctionDef) */ {
 public:
  FunctionDef();
  virtual ~FunctionDef();
  ...
  FunctionDef* New(::cv::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::cv::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::cv::protobuf::Message& from) PROTOBUF_FINAL;
  ...
  protected:
  explicit FunctionDef(::cv::protobuf::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::cv::protobuf::Arena* arena);
  private:
  ...
  ::cv::protobuf::RepeatedPtrField< ::opencv_tensorflow::FunctionDef_Node >*
      mutable_node();
  const ::cv::protobuf::RepeatedPtrField< ::opencv_tensorflow::FunctionDef_Node >&
      node() const;
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::cv::protobuf::RepeatedPtrField< ::opencv_tensorflow::FunctionDef_Node > node_;
...
class GradientDef : public ::cv::protobuf::Message /* @@protoc_insertion_point(class_definition:opencv_tensorflow.GradientDef) */ {
 public:
  GradientDef();
  virtual ~GradientDef();
  ...
  GradientDef* New(::cv::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::cv::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::cv::protobuf::Message& from) PROTOBUF_FINAL;
  ...
  protected:
  explicit GradientDef(::cv::protobuf::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::cv::protobuf::Arena* arena);
  private:
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::cv::protobuf::internal::ArenaStringPtr function_name_;
  ::cv::protobuf::internal::ArenaStringPtr gradient_func_;
  mutable int _cached_size_;
  friend struct ::protobuf_function_2eproto::TableStruct;
...
inline ::cv::protobuf::RepeatedPtrField< ::opencv_tensorflow::FunctionDef >*
...
inline const ::cv::protobuf::RepeatedPtrField< ::opencv_tensorflow::FunctionDef >&
...
inline ::cv::protobuf::RepeatedPtrField< ::opencv_tensorflow::GradientDef >*
...
inline const ::cv::protobuf::RepeatedPtrField< ::opencv_tensorflow::GradientDef >&
...
inline void FunctionDef_Node::set_op(const ::std::string& value) {
  ...
  op_.Set(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
...
inline void FunctionDef_Node::set_op(const char* value) {
  ...
  op_.Set(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
...
inline void FunctionDef_Node::set_op(const char* value,
  ...
  op_.Set(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
...
inline ::std::string* FunctionDef_Node::mutable_op() {
  ...
  return op_.Mutable(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* FunctionDef_Node::release_op() {
  // @@protoc_insertion_point(field_release:opencv_tensorflow.FunctionDef.Node.op)

  return op_.Release(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline void FunctionDef_Node::set_allocated_op(::std::string* op) {
  ...
  op_.SetAllocated(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(), op,
      GetArenaNoVirtual());
...
inline ::std::string* FunctionDef_Node::unsafe_arena_release_op() {
  ...
  return op_.UnsafeArenaRelease(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(),
      GetArenaNoVirtual());
}
inline void FunctionDef_Node::unsafe_arena_set_allocated_op(
  ...
  op_.UnsafeArenaSetAllocated(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(),
...
inline const ::cv::protobuf::Map< ::std::string, ::opencv_tensorflow::AttrValue >&
FunctionDef_Node::attr() const {
  // @@protoc_insertion_point(field_map:opencv_tensorflow.FunctionDef.Node.attr)
  return attr_.GetMap();
}
inline ::cv::protobuf::Map< ::std::string, ::opencv_tensorflow::AttrValue >*
...
inline void FunctionDef::set_allocated_signature(::opencv_tensorflow::OpDef* signature) {
  ...
  if (message_arena == NULL) {
    delete reinterpret_cast< ::cv::protobuf::MessageLite*>(signature_);
  }
  if (signature) {
    ::cv::protobuf::Arena* submessage_arena =
      reinterpret_cast< ::cv::protobuf::MessageLite*>(signature)->GetArena();
    if (message_arena != submessage_arena) {
      signature = ::cv::protobuf::internal::GetOwnedMessage(
...
inline ::cv::protobuf::RepeatedPtrField< ::opencv_tensorflow::FunctionDef_Node >*
FunctionDef::mutable_node() {
  // @@protoc_insertion_point(field_mutable_list:opencv_tensorflow.FunctionDef.node)
  return &node_;
}
inline const ::cv::protobuf::RepeatedPtrField< ::opencv_tensorflow::FunctionDef_Node >&
...
inline void GradientDef::set_function_name(const ::std::string& value) {
  ...
  function_name_.Set(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
...
inline void GradientDef::set_function_name(const char* value) {
  ...
  function_name_.Set(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
...
inline void GradientDef::set_function_name(const char* value,
  ...
  function_name_.Set(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
...
inline ::std::string* GradientDef::mutable_function_name() {
  ...
  return function_name_.Mutable(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* GradientDef::release_function_name() {
  ...
  return function_name_.Release(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline void GradientDef::set_allocated_function_name(::std::string* function_name) {
  ...
  function_name_.SetAllocated(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(), function_name,
      GetArenaNoVirtual());
...
inline ::std::string* GradientDef::unsafe_arena_release_function_name() {
  ...
  return function_name_.UnsafeArenaRelease(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(),
      GetArenaNoVirtual());
}
inline void GradientDef::unsafe_arena_set_allocated_function_name(
  ...
  function_name_.UnsafeArenaSetAllocated(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(),
...
inline void GradientDef::set_gradient_func(const ::std::string& value) {
  ...
  gradient_func_.Set(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
...
inline void GradientDef::set_gradient_func(const char* value) {
  ...
  gradient_func_.Set(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
...
inline void GradientDef::set_gradient_func(const char* value,
  ...
  gradient_func_.Set(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
...
inline ::std::string* GradientDef::mutable_gradient_func() {
  ...
  return gradient_func_.Mutable(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* GradientDef::release_gradient_func() {
  ...
  return gradient_func_.Release(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline void GradientDef::set_allocated_gradient_func(::std::string* gradient_func) {
  ...
  gradient_func_.SetAllocated(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(), gradient_func,
      GetArenaNoVirtual());
...
inline ::std::string* GradientDef::unsafe_arena_release_gradient_func() {
  ...
  return gradient_func_.UnsafeArenaRelease(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(),
      GetArenaNoVirtual());
}
inline void GradientDef::unsafe_arena_set_allocated_gradient_func(
  ...
  gradient_func_.UnsafeArenaSetAllocated(&::cv::protobuf::internal::GetEmptyStringAlreadyInited(),
